...
public class GestorDisco {
    ...
    // --- ESTE ES EL MÉTODO QUE FALTABA Y EL PLANIFICADOR ESTABA PIDIENDO ---
    public boolean hayEspacioSuficiente(int tamañoRequerido) {
        return this.bloquesLibres >= tamañoRequerido;
    }
